...
<div class="ui segment" style="padding: 10 20 0 20;text-align: center">
    <div class="col-md-6">
		...
		if (isset($evento) && count($evento)) {
			...
			?>
	                <tr>
	                    <td><span><?= $ev->identificador_evento . ' ' . $ev->sigla_campeonato ?></span></td>
	                    <td style="text-align: center"><?= $ev->nome_cidade . '/' . $ev->nome_uf ?></td>
	                    <td style="text-align: right"><?= date('d/m/Y', strtotime($ev->data_evento)) ?></td>
	                </tr>
			<?php
		    }
		} else {
